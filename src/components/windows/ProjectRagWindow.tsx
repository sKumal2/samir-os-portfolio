...
const PILLS = ["Python", "LangChain", "Vector DB", "RAG", "Embeddings"];

const METRICS = [
  { value: "10×",  label: "Query Scalability" },
  { value: "35%",  label: "Insight Accuracy Gain" },
  { value: "3",    label: "Data Sources" },
  { value: "RAG",  label: "Architecture" },
];

const NODES = ["WHO / CDC APIs", "Ingestion", "Embeddings", "Vector DB", "RAG Engine", "Insights"];

export function ProjectRagWindow() {
  return (
    <div className="flex flex-col h-full" style={{ background: "#0d1117" }}>
      ...
      <div className="p-5 border-b border-[#1e2a3a] space-y-3 flex-shrink-0">
        ...
        <h2
          ...
          style={{ fontFamily: "var(--font-space-mono), monospace" }}
        >
          RAG-Based Clinical Data Integration System
        </h2>
        <p
          className="text-sm text-[#e2e8f0] leading-relaxed"
          style={{ fontFamily: "var(--font-inter), sans-serif" }}
        >
          Context-aware clinical analytics powered by retrieval-augmented generation
        </p>
      ...
      <div className="border-t border-[#1e2a3a] px-5 py-3 flex-shrink-0">
        <a
          href="https://github.com/sKumal2/healthcare-system"
          target="_blank"
