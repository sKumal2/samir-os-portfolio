...
const PILLS = ["Python", "PyTorch", "Pandas", "NumPy", "Statistical Sampling"];

const METRICS = [
  { value: "92.6%", label: "F1-Score" },
  { value: "33%",   label: "Rare-Class Detection Gain" },
  { value: "29K",   label: "Images Processed" },
  { value: "Low",   label: "Latency Inference" },
];

const NODES = ["29K Images", "Sampling", "Preprocess", "PyTorch Model", "Evaluation", "Inference"];

export function ProjectLesionWindow() {
  return (
    <div className="flex flex-col h-full" style={{ background: "#0d1117" }}>
      ...
      <div className="p-5 border-b border-[#1e2a3a] space-y-3 flex-shrink-0">
        ...
        <h2
          ...
          style={{ fontFamily: "var(--font-space-mono), monospace" }}
        >
          AI-Powered Skin Lesion Classification Pipeline
        </h2>
        <p
          className="text-sm text-[#e2e8f0] leading-relaxed"
          style={{ fontFamily: "var(--font-inter), sans-serif" }}
        >
          92.6% F1-score ML pipeline over 29K medical images with optimized rare-class detection
        </p>
      ...
      <div className="border-t border-[#1e2a3a] px-5 py-3 flex-shrink-0">
        <a
          href="https://github.com/sKumal2/skinLesion_VIT"
          target="_blank"
