  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 pb-4 border-b border-[#1f2937]">
        <div
          className="h-12 w-12 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center text-white font-bold text-lg flex-shrink-0"
      ...
      <div
        className="pt-4 flex gap-4 text-xs text-zinc-600 border-t border-[#1f2937]"
        style={{ fontFamily: "var(--font-space-mono), monospace" }}
      >
        <span>GSU CS &apos;28</span>
        <span>·</span>
